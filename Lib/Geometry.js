...
{
    const mesh = new window.threeCore.THREE.Mesh( new window.threeCore.THREE.PlaneGeometry( size_x,size_y ), new window.threeCore.THREE.MeshStandardMaterial( { color: new threeCore.THREE.Color( "hsl(238, 20%, 50%)"),roughness :1, depthWrite: false } ) );
